...
L = {
 "es": {
  ...
  "prev": [
    ...
    "<b>Director Digital &amp; Data — MEC / GroupM</b> · Bogotá · Abr 2013 – Dic 2017",
 ...
 "en": {
  ...
  "prev": [
    ...
    "<b>Digital &amp; Data Director — MEC / GroupM</b> · Bogotá · Apr 2013 – Dec 2017",
...
PROFILES = {
 ...
 "Analytics_Products_BI": {
   ...
   "cases": {"es":[("RAC Insights 360","producto de inteligencia de mercado: base longitudinal 2003–2025, 12 módulos analíticos y narrativas ejecutivas con IA."),
                   ...
                   ("RAC Evolution — Filtro TARGET","evolución del dashboard con segmentación y recálculo selectivo, optimizando costos cloud."),
                   ("Databricks — Análisis por industria (BNA)","análisis de ventas, precio y drop size con Pareto y series temporales en PySpark.")],
             "en":[("RAC Insights 360","market-intelligence product: longitudinal base 2003–2025, 12 analytical modules and AI executive narratives."),
                   ...
                   ("RAC Evolution — TARGET filter","dashboard evolution with segmentation and selective recompute, optimizing cloud cost."),
